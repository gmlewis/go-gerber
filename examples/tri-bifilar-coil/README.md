# Tri (3-layer) bifilar coil

This is a design of a tri bifilar coil, meaning that when this design is
...
![tri-bifilar-coil-diagram](tri-bifilar-coil-diagram.png)

This shows the various layers on a small (n=20) coil to highlight
the wiring and various layers of the PCB:

![tri-bifilar-coil-layers](tri-bifilar-coil-layers.gif)
