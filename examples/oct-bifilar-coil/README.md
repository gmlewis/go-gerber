# Oct (8-layer) bifilar coil

This is a design of an oct bifilar coil, meaning that when this design is
fabricated on a 8-layer printed circuit board (PCB), there will be
8 bifilar coils wired in series, one bifilar coil per layer.
...
![oct-bifilar-coil-diagram](oct-bifilar-coil-diagram.png)

This shows the various layers on a small (n=12) coil to highlight
the wiring and various layers of the PCB:

![oct-bifilar-coil-layers](oct-bifilar-coil-layers.gif)
