...
func main() {
	...
	if *fontName != "" {
		...
		tss.Add(
			...
			Text(hole10.X, hole10.Y-2*viaPadD, 1.0, "hole10", *fontName, labelSize, &TextOpts{XAlign: XCenter, YAlign: YTop}),
			Text(hole11.X-padD, hole11.Y+0.5*padD, 1.0, "hole11", *fontName, labelSize, &TextOpts{XAlign: XRight, YAlign: YTop}),
